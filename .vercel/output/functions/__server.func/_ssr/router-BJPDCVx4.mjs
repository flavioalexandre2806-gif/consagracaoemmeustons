...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BJPDCVx4.js
var router_BJPDCVx4_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-Ksv-FYtC.css";
var APP_NAME = "Consagração em Meus Tons";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Repertório litúrgico de Flávio Vieira — cânticos, partituras e agenda."
			},
			{
				name: "theme-color",
				content: "#070707"
...
var $$splitComponentImporter = () => import("./routes-DNXFIuWW.mjs");
...
//#endregion
export { getRouter, router_BJPDCVx4_exports as t };
